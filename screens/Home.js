...
export default function Home({ navigation }) {
  const apiUrlList = 'https://api.themoviedb.org/4/list/1?page=1&api_key=9eccd2f76e387bef9ff61b5805ae15b3&sort_by=original_order.asc';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.filterContainer}>
        <Text style={styles.filter} onPress={() => UpcomingHandler()}>
          Upcoming
        </Text>
        <Text style={styles.filter} onPress={() => PopularHandler()}>
          Popular
        </Text>
        <Text style={styles.filter} onPress={() => TopRatedHandler()}>
          Top Rated
        </Text>
      </View>
